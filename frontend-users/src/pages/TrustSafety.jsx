            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-12">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h1 className="text-4xl font-black text-gray-900 tracking-tight">Trust & Safety</h1>
                    </div>

                    <div className="prose max-w-none text-gray-600">
                        <p className="text-lg leading-relaxed mb-8">
                            Welcome to the Trust & Safety page. This section contains important information regarding our policies, guidelines, and resources. Our team is constantly working to provide you with the most up-to-date and accurate information.
                        </p>
                        
                        <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-5">1. Overview</h2>
                        <p className="mb-6 leading-relaxed">
                            Details regarding this topic are currently being updated. Please check back later for comprehensive and detailed guidelines specific to Trust & Safety. We appreciate your patience as we finalize our documentation.
                        </p>
